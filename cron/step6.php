...
$connection->queryExecute("INSERT INTO cron_loads (LoadDate,LoadTYpe,FileDateUnix,FileDate,Status) VALUES (NOW(),'3','0',NOW(),'0')");

$file_report = $_SERVER["DOCUMENT_ROOT"]."/cron/report_step6.txt";

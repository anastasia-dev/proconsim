...
$APPLICATION->SetPageProperty("description", "Контакты региональных филиалов компании Проконсим.");
$APPLICATION->SetTitle("Региональные филиалы");
?><h1 class="title title2">Региональные филиалы</h1>

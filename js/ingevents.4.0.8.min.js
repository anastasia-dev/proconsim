...
window.addEventListener('load', function() {
	// Init configurations
    ingEvents.init({});
	$('div.tender-paty input.tender-send[type="button"]').click(function() {
		var currentLink = $('div.tender-paty input.tender-link').val();
		if(currentLink != '') {
			ingEvents.listTrackers();
			ingEvents.dataLayerPush('dataLayer', {'event': 'tender'});
		}
	});
});
...
/*function evn(evnum){ 
		if(evnum==1){ingEvents.Event({category:"forms",action:"submit",label:"zakaz",ya_label:"zakaz"});}
		
	}
	ingEvents.dataLayerPush('dataLayer', {'event': 'consult'});*/

...
<div class="col-sm-4 hidden-xs"></div>
	<div class="bx-404-container col-sm-4">
		<div class="bx-404-block"><img src="<?=SITE_DIR?>images/404.png" alt=""></div>
		<div class="bx-404-text-block">Неправильно набран адрес,<br>или такой страницы на сайте больше не существует.</div><br>
		<div class="inf-box box-main" style="padding:25px 0;"><a href="/" style="padding-left:65px;">Перейти на главную</a></div>

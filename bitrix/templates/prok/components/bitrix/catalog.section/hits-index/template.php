...
if(count($arResult['ITEMS'])){
    ?>
    <section class="content-inside hits-index">
        <div class="container">
            <h2 class="title"><span>Хиты продаж</span></h2>
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="product-card">
                            ...
                            <div class="bottom-info-panel">
                                ...
                                <?if(empty($arItem['OFFERS'])):?>
                                    <?if ($arItem['CAN_BUY']):
                                        $addToBasketUrl = $arItem['DETAIL_PAGE_URL'] . $arItem['ADD_URL'];
                                        $addToBasketUrl = str_replace('//?', '/?', $addToBasketUrl);
                                        ?>
                                    ...
                                    <?}?>
                                        <div class="row" style="display: flex;align-items: center;flex-wrap: wrap;">
                                            ...
                                            <div class="col-sm-6 col-xs-12">
                                                ...
                                                <button class="btn-bye-large b-g-s-<?=$arItem['ID']?>" onclick="addToBasket('<?echo $addToBasketUrl;?>','<?=$arItem['ID']?>');">КУПИТЬ<?if(intval($arResult['BASKET'][$arItem['ID']]) != 0):?><span class="in-basket-count"><?=intval($arResult['BASKET'][$arItem['ID']])?></span><?endif;?></button>
                                            </div>
                                        </div>

...
$MESS['SOA_ORDER_MANAGER'] = "В ближайшее время Вам позвонит менеджер компании для подтверждения резервирования товара и согласования сроков и условий доставки и оплаты.";
$MESS['SOA_ORDER_CAUTION'] = "Просим обратить внимание!";
$MESS['SOA_ORDER_PAYINFO'] = "Оплата заказа будет доступна после подтверждения резерва.";
$MESS['SOA_ORDER_THS'] = "Благодарим за Ваш заказ!";
$MESS['SOA_ORDER_COMPANY'] = "Компания «Проконсим»";

$MESS['SOA_ORDER_SUC1'] = "Скачать счет на оплату, оплатить заказ, следить за выполнением своего заказа в Вы сможете  в  <a href=\"#LINK#\">Персональном разделе сайта</a>. Обратите внимание, что для входа в этот раздел вам необходимо будет ввести логин и пароль пользователя сайта.";

...
else
{
	...
	<div class="row col-md-12 col-sm-12">
		...
		$clearFromLink = array("filter_history","filter_status","show_all", "show_canceled", "how_order");
		...
		{
			?>
			<a class="sale-order-history-link" href="<?=$APPLICATION->GetCurPageParam("show_orders=Y", $clearFromLink, false)?>">
							...
							<div class="row sale-order-list-inner-row">
								...
								<div class="sale-order-list-inner-row-body">
									<div class="col-md-9 col-sm-8 col-xs-12 sale-order-list-payment">
										...
										if ($payment['PAID'] !== 'Y' && $order['ORDER']['LOCK_CHANGE_PAYSYSTEM'] !== 'Y' && 1==3)
										{
											?>
									...
									<?
									if ($payment['PAID'] === 'N' && $payment['IS_CASH'] !== 'Y' && 1==3)
									{

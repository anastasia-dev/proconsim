...
<? if (!empty($arResult['ITEMS'])): ?>
	...
	<section class="carousel-goods">
		<div class="row">
			<div class="col-md-12">
				<h3><?=GetMessage("CATALOG_RECOMMENDED_PRODUCTS_HREF_TITLE_TEST")?></h3>
				<div class="owl-carousel2">
					<?foreach($arResult['ITEMS'] as $arItem):?>
					<div class="item">
						<div class="item-wrap">
							<div class="rows table-rows">
								<div class="g-img"><a href="<?=$arItem['DETAIL_PAGE_URL']?>"><img src="<?=$arItem['PREVIEW_PICTURE']['SRC']?>" alt=""></a></div>
								...
								<?else:?>
									...
									<div class="g-price price-product-<?=$arItem['OFFERS'][0]['ID']?>"><?=number_format($arItem['OFFERS'][0]['MIN_PRICE']['DISCOUNT_VALUE'],0,'',' ');?> <span>руб</span></div>
									<div class="g-count">Кол-во
										<div class="wrap-count">

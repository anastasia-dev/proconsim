...
$MESS["AUTH_REGISTER_HEAD"] = "Активация личного кабинета осуществляется в течении 24 часов";
$MESS["REGISTER_CAPTCHA_TITLE"] = "Защита от роботов: *";
$MESS["REGISTER_CAPTCHA_PROMT"] = "Введите слово на картинке";
$MESS["AUTH_REQ"] = " — поля, отмеченные звездочкой, обязательны к заполнению";

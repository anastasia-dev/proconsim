...
<div class="goods-wrap">
	...
	<div class="goods-item">
		<div class="g-img"><a href="goods.html"><img src="<?=SITE_TEMPLATE_PATH?>/img/img-temp.png" alt=""></a></div>
		<div class="g-desc"><p><a href="goods.html">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore </a></p></div>
		<div class="g-price">999 455 <span>руб</span></div>
		<div class="g-count">
		...
		<div class="g-btn"><button class="btn-bye"><i class="demo-icon icon-cart"></i></button></div>
	</div>
</div>
...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	?><div class="bx_catalog_item double"><div class="bx_catalog_item_container goods-item " id="<? echo $strMainID; ?>">
		<div class="g-img"><a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"><img src="<? echo $arItem['PREVIEW_PICTURE']['SRC']; ?>" alt=""></a></div>
		<div class="g-desc"><p><a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" title="<? echo $productTitle; ?>"><? echo $productTitle; ?> </a></p></div>

	<div class="bx_catalog_item_price"><div id="<? echo $arItemIDs['PRICE']; ?>" class="bx_price g-price"><?
	if (!empty($minPrice))
	{

...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	?>
		<div class="bx_catalog_item double"><div class="bx_catalog_item_container goods-item " id="<? echo $strMainID; ?>">
			<div class="g-img"><a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" id="<? echo $arItemIDs['PICT']; ?>" class="bx_catalog_item_images"><img src="<? echo $arItem['PREVIEW_PICTURE']['SRC']; ?>" alt=""></a></div>
		<div class="g-desc"><p><a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" title="<? echo $productTitle; ?>"><? echo $arItem['NAME']; ?> </a></p></div>
...
<?/*
	...
	{
		?><a id="<? echo $arItemIDs['SECOND_PICT']; ?>" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="bx_catalog_item_images_double" style="display: none; background-image: url('<? echo (
	...
	?>
	<div class="bx_catalog_item_price g-price"><div id="<? echo $arItemIDs['PRICE']; ?>" class="bx_price g-price"><?
	if (!empty($minPrice))
	{
	...
	if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS']))
	{
		...
		if ($arItem['CAN_BUY'])
		{
			...
			{
			?>
		<div class="bx_catalog_item_controls_blockone g-count"><div class="wrap-count">
			<button id="<? echo $arItemIDs['QUANTITY_DOWN']; ?>" href="javascript:void(0)" class="bx_bt_button_type_2 bx_small" rel="nofollow">-</button>
			...
			<span style="display:none;" id="<? echo $arItemIDs['QUANTITY_MEASURE']; ?>"><? echo $arItem['CATALOG_MEASURE_NAME']; ?></span>
			<button id="<? echo $arItemIDs['QUANTITY_UP']; ?>" href="javascript:void(0)" class="bx_bt_button_type_2 bx_small" rel="nofollow">+</button>
			
		</div></div>
			<?
			}
			?>
		<div id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>" class="bx_catalog_item_controls_blocktwo g-btn">
			<button id="<? echo $arItemIDs['BUY_LINK']; ?>" class="bx_bt_button bx_medium btn-bye" href="javascript:void(0)" rel="nofollow"><?
			if ($arParams['ADD_TO_BASKET_ACTION'] == 'BUY')
			{
				echo '<i class="demo-icon icon-cart"></i>';
			}
			else
			{
				echo '<i class="demo-icon icon-cart"></i>';
		...
		{
			?><div class="bx_catalog_item_controls_blockone g-count">
				Нет в наличии 
			</div >
			<div id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>" class="bx_catalog_item_controls_blocktwo g-btn">
					<button id="<? echo $arItemIDs['BUY_LINK']; ?>" disabled class="bx_bt_button bx_medium btn-bye" href="javascript:void(0)" rel="nofollow"><?
					if ($arParams['ADD_TO_BASKET_ACTION'] == 'BUY')
					{
						echo '<i class="demo-icon icon-cart"></i>';
					}

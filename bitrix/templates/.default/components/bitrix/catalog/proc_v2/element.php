...
<div class="row">
<div class="col-md-3">
	<div class="menu-cat menu-catalog-page menu-page-goods hidden-xs hidden-sm">
...
<?$APPLICATION->IncludeComponent(
	"bitrix:news.list", 
	"catalog-banners-tovar", 
	array(
		"COMPONENT_TEMPLATE" => "catalog-banners-tovar",
		"IBLOCK_TYPE" => "visual",
		"IBLOCK_ID" => "4",
		"NEWS_COUNT" => "20",
		"SORT_BY1" => "SORT",

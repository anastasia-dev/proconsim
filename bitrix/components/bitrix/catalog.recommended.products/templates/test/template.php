						...
						<div class="item-wrap">
							<div class="rows table-rows">
								...
								<?if(empty($arItem['OFFERS'])):?>
									<input type="hidden" id="price-value-<?=$arItem['ID']?>" value="<?=$arItem['MIN_PRICE']['VALUE']?>">
									<div class="g-price" id="price-product-<?=$arItem['ID']?>"><?=number_format($arItem['MIN_PRICE']['DISCOUNT_VALUE_VAT'],0,'',' ');?> <span>руб</span></div>
								...
								<?else:?>
									<input type="hidden" id="price-value-<?=$arItem['OFFERS'][0]['ID']?>" value="<?=$arItem['MIN_PRICE']['VALUE']?>">
									<div class="g-price" id="price-product-<?=$arItem['OFFERS'][0]['ID']?>"><?=number_format($arItem['OFFERS'][0]['MIN_PRICE']['DISCOUNT_VALUE_VAT'],0,'',' ');?> <span>руб</span></div>
									<div class="g-count">Кол-во
										<div class="wrap-count">

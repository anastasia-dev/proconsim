...
if($isAjax)
{
	...
	$arParams['JQUERY_BACKDROP_BACKGROUND'] = ($arParams['JQUERY_BACKDROP_BACKGROUND'] ? trim($arParams['JQUERY_BACKDROP_BACKGROUND']) : '#3879D9');
	$arParams['JQUERY_BACKDROP_OPACITY']    = ($arParams['JQUERY_BACKDROP_OPACITY'] ? trim($arParams['JQUERY_BACKDROP_OPACITY']) : '0.1');
	$arParams['JQUERY_BACKDROP_Z_INDEX']    = ($arParams['JQUERY_BACKDROP_Z_INDEX'] ? intval($arParams['JQUERY_BACKDROP_Z_INDEX']) : 900);

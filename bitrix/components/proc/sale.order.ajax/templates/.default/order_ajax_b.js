...
(function() {
	...
	BX.Sale.OrderAjaxComponent = {
		...
		editDeliveryInfo: function(deliveryNode)
		{
			...
			{			    
			    if((currentDelivery.PRICE == 0 || currentDelivery.PRICE === 'undefined') && (currentDelivery.ID==16 || currentDelivery.ID==31)){
		...
		getDeliveryPriceNodes: function(delivery)
		{
			...
			{		    
                if((delivery.PRICE==0 || delivery.PRICE === 'undefined') && (delivery.ID==16 || delivery.ID==31)){                     
                    priceNodesArray = [];
                }else{
		...
		createDeliveryItem: function(item)
		{
			...
			{
			    if((item.PRICE == 0 || item.PRICE === 'undefined') && (deliveryId==16 || deliveryId==31)){
			...
			{
			    if((deliveryCached.PRICE == 0 || deliveryCached.PRICE === 'undefined') && (deliveryId==16 || deliveryId==31)){

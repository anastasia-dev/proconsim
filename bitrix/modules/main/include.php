...
/*ZDUyZmZZDk3N2U5Y2U0NGZlYmU0MmU2ZTkyMTUzMzQwZTc3N2E=*/$GLOBALS['____1940926854']= array(base64_decode('ZGVmaW5l'));if(!function_exists(__NAMESPACE__.'\\___77548968')){function ___77548968($_1105908083){static $_2018898022= false; if($_2018898022 == false) $_2018898022=array('R'.'U'.'5DT0RF','WQ==');return base64_decode($_2018898022[$_1105908083]);}};class CBXFeatures{ public static function IsFeatureEnabled($_1327081965){ return true;} public static function IsFeatureEditable($_1327081965){ return true;} public static function SetFeatureEnabled($_1327081965, $_845563065= true){} public static function SaveFeaturesSettings($_1568504313, $_96248925){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_1219478439){} public static function ModifyFeaturesSettings($_1219478439, $_452844778){} public static function IsFeatureInstalled($_1327081965){ return true;}} $GLOBALS['____1940926854'][0](___77548968(0), ___77548968(1));/**/			//Do not remove this

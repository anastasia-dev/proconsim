...
Class ingate_seo extends CModule
{
	...
	function InstallEvents()
	{
		...
		$event->registerEventHandler("main", "OnBuildGlobalMenu", $this->MODULE_ID, "\Ingate\Seo\Event", "OnBuildGlobalMenu", 9000);
		$event->registerEventHandler("main", "OnEndBufferContent", $this->MODULE_ID, "\Ingate\Seo\Event", "OnEndBufferContent", 9000);
		$event->registerEventHandler("main", "OnEpilog", $this->MODULE_ID, "\Ingate\Seo\Event", "OnEpilog", 9000);
		$event->registerEventHandler("main", "OnPageStart", $this->MODULE_ID, "\Ingate\Seo\Event", "OnPageStart", 9000);
	}

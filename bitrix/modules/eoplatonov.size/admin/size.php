...
$APPLICATION->SetTitle(GetMessage("ESF_SET_TITLE"));
?>
...
function normalize_arDir(&$arDir){
    ...
    <style>
        ...
        .eoplatonov_size li.file:before{
            content: "\25ba";
            position: absolute;
            margin-left: -15px;
            font-size: 8px;
        ...
        .eoplatonov_size li.folder:before{
             content: "\2752";
             position:absolute;
             margin-left:-20px;
             color: #4c00fd;
        }
        .eoplatonov_size li.folder{
             cursor:pointer;
        }
        .eoplatonov_size li.folder.open>ul{
            display:block;
        }
        .eoplatonov_size .size{
            font-size:12px;
        }
        .eoplatonov_size .size.silver{
            color:silver;
        }
        .eoplatonov_size .size.green{
            color: #32CF10;
        }
        .eoplatonov_size .size.orange{
            color: #FAA912;
        }
        .eoplatonov_size .size.red{
            color:red;
        }
    </style>
    ...
    <?
    print "<div class='eoplatonov_size'>";
        print "<div class='all_size'>".GetMessage("ESF_ALL_SIZE")." ".ConvertBytes($arDir[size_folder])."<br>(".GetMessage("ESF_INFO").")</div>";

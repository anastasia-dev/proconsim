...
$pdf->MultiCell(62, 15, $pdf->prepareToPdf('Цена,руб'), 'LTR', 'C');
    $pdf->Ln(0);
       ...
       while( $arSection = $dbSection-> GetNext(true, false) ){
           ...
           $pdf->SetFont($fontFamily, 'B', $fontSize);
           $pdf->Cell($width, 15, $pdf->prepareToPdf($arSection['NAME']), 'LTR', 2, 'C');
    ...
    //echo "YY= ". $pH." - ".$hieghtCell."<br />";   
                    ...
                    //$pdf->MultiCell(32, $hieghtCell, $pdf->prepareToPdf('Компл'), 'LT', 'C');
                    $x = $x+32;
                    $pdf->SetXY($x, $y);
                    //echo "x=". $x.", y=".$y."<br />";                    
                   ...
                   // $pdf->SetXY($x, $y);
                    ...
                    //$pdf->MultiCell(62, $hieghtCell, $pdf->prepareToPdf('99 999 999,99'), 'LTR', 'R'); 
                    $pdf->Ln(0);						
                }   
           }
       }
    ...
    $myfile='pdf-new.pdf';
    $pdf->Output($myfile, 'F');
    if (!copy($myfile,$_SERVER['DOCUMENT_ROOT'].'/upload/pdf-new2.pdf'))
    {  }else{  unlink($myfile);  } 
    //}
?>
